...
testError <- mean(sqrt((as.numeric(as.character(bagpred)) - as.numeric(as.character(testingData$Occupancy)))^2))

```
Drawing $1000$ bootstrap samples resulted in an out-of-bag estimate of misclassification error of `r testError` and thus a test accuracy of `r 1-testError` which greatly exceeds the other methods examined.
